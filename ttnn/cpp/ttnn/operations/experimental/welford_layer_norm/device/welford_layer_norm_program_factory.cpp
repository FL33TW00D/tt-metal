...
#include "ttnn/operations/experimental/welford_layer_norm/device/welford_layer_norm_program_factory.hpp"
...
operation::ProgramWithCallbacks welford_layer_norm_multi_core(
    ...
    bool is_welford_layer_norm = page_table.has_value();
    ...
    std::vector<uint32_t> reader_compile_time_args = {
        ...
        index_stick_size,
        // page_table args
        (std::uint32_t)is_welford_layer_norm,
    ...
    auto unary_reader_kernel_id = tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/experimental/welford_layer_norm/device/kernels/dataflow/"
    ...
    auto compute_kernel_id = tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/experimental/welford_layer_norm/device/kernels/compute/update_cache.cpp",
        all_cores,
    ...
    for (uint32_t i = 0, num_tiles_read = 0; i < num_cores; ++i) {
        ...
        SetRuntimeArgs(
            ...
            core,
            {
                ...
                index_buffer_addr,
                i,
                is_welford_layer_norm ? page_table.value().buffer()->address() : 0,
                wait_to_start,
            });
    ...
    auto override_runtime_arguments_callback =
        [unary_reader_kernel_id,
         ...
         is_welford_layer_norm](
            ...
            const std::vector<uint32_t> update_idxs =
                static_cast<const WelfordLayerNormDeviceOperation*>(operation)->update_idxs;
            ...
            auto page_table_tensor_addr =
                is_welford_layer_norm ? optional_input_tensors.at(1).value().buffer()->address() : 0;
