...
void MAIN {
    ...
    //     constexpr uint32_t out_subblock_num_tiles = get_compile_time_arg_val(10);  // out_subblock_h *
    //     out_subblock_w; constexpr uint32_t batch = get_compile_time_arg_val(11);                   // batch dim
    ...
    //     mm_block_init(
    //         in0_cb_id, in1_cb_id, mm_partials_cb_id, in1_transpose_tile, out_subblock_w, out_subblock_h,
    //         in0_block_w);
    ...
    //                     uint32_t dst_index = 0;  // start at 0, each call to matmul_block internally increments
    //                     dst_index uint32_t in0_index = in0_index_subblock_offset;  // offset into in0 block uint32_t
    ...
    //                         in1_index += in1_per_core_w;  // to stride down by 1 need to stride by in_per_core_w
    //                         (should be
    //                                                       // called in1_block_w)
    //                     }
    ...
    //             mm_block_init_short(in0_cb_id, in1_cb_id, in1_transpose_tile, out_subblock_w, out_subblock_h,
    //             in0_block_w);
