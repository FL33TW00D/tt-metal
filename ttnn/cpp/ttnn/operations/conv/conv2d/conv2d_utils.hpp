...
struct Conv2dConfig {
    ...
    // If true tensor will be deallocated if it's on device.
    bool deallocate_activation = false;
    // If true after halo device op is done, the output tensor will be reallocated.
    bool reallocate_halo_output = true;
    uint32_t act_block_h_override = 0;
    // Amount by which the maximum possible act_block_width is divided. Max act_block_w = in_channels /
