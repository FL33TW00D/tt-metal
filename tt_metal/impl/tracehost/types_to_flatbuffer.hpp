...
inline tt::target::DataFormat ToFlatbuffer(tt::DataFormat input) {
    switch (input) {
        case tt::DataFormat::Float32: return tt::target::DataFormat::Float32;
        case tt::DataFormat::Float16: return tt::target::DataFormat::Float16;
        case tt::DataFormat::Bfp8: return tt::target::DataFormat::Bfp8;
        case tt::DataFormat::Bfp4: return tt::target::DataFormat::Bfp4;
        case tt::DataFormat::Bfp2: return tt::target::DataFormat::Bfp2;
        case tt::DataFormat::Float16_b: return tt::target::DataFormat::Float16_b;
        case tt::DataFormat::Bfp8_b: return tt::target::DataFormat::Bfp8_b;
        case tt::DataFormat::Bfp4_b: return tt::target::DataFormat::Bfp4_b;
        case tt::DataFormat::Bfp2_b: return tt::target::DataFormat::Bfp2_b;
        case tt::DataFormat::Lf8: return tt::target::DataFormat::Lf8;
        case tt::DataFormat::Fp8_e4m3: return tt::target::DataFormat::Fp8_e4m3;
        case tt::DataFormat::Int8: return tt::target::DataFormat::Int8;
        case tt::DataFormat::Tf32: return tt::target::DataFormat::Tf32;
        case tt::DataFormat::UInt8: return tt::target::DataFormat::UInt8;
        case tt::DataFormat::UInt16: return tt::target::DataFormat::UInt16;
        case tt::DataFormat::Int32: return tt::target::DataFormat::Int32;
        case tt::DataFormat::UInt32: return tt::target::DataFormat::UInt32;
        case tt::DataFormat::RawUInt8: return tt::target::DataFormat::RawUInt8;
        case tt::DataFormat::RawUInt16: return tt::target::DataFormat::RawUInt16;
        case tt::DataFormat::RawUInt32: return tt::target::DataFormat::RawUInt32;
        case tt::DataFormat::Invalid: return tt::target::DataFormat::Invalid;
...
inline flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<tt::target::RuntimeArg>>> ToFlatbuffer(
...
inline flatbuffers::Offset<tt::target::Tile> ToFlatbuffer(const Tile& tile, flatbuffers::FlatBufferBuilder& builder) {
...
inline flatbuffers::Offset<tt::target::CircularBufferConfig> ToFlatbuffer(
    ...
    // FIXME (kmabee) - Handle const Buffer* shadow_global_buffer too, and other things missed.
