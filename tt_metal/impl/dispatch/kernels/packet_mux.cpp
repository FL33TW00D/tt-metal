...
constexpr uint32_t mux_input_ptr_buffers[MAX_SWITCH_FAN_IN] =
    {
...
constexpr uint32_t mux_input_remote_ptr_buffers[MAX_SWITCH_FAN_IN] =
    {
...
constexpr init_params_t output_queue_init_params{
    ...
    .ptrs_addr = mux_output_ptr_buffer,
    .remote_ptrs_addr = mux_output_remote_ptr_buffer,

    .cb_mode = output_depacketize,
...
inline void initialize_input_queues() {
    ...
    process_queues<input_queue_network_sequence, input_queue_cb_mode_sequence>([&]<auto network_type, auto cbmode, auto sequence_i>(auto) -> bool {
        ...
        init_params.ptrs_addr = mux_input_ptr_buffers[sequence_i];
        init_params.remote_ptrs_addr = mux_input_remote_ptr_buffers[sequence_i];
