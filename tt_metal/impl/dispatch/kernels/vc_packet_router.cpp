...
PacketInputQueueVariant raw_input_queues[MAX_SWITCH_FAN_IN];
...
PacketOutputQueueVariant raw_output_queues[MAX_SWITCH_FAN_OUT];
...
inline void initialize_input_queues() {
    ...
    process_queues<input_queue_network_sequence, input_queue_cb_mode_sequence>([&]<auto network_type, auto cbmode, auto sequence_i>(auto) -> bool {
        ...
        init_params.ptrs_addr = vc_packet_router_input_ptr_buffers[sequence_i];
        init_params.remote_ptrs_addr = vc_packet_router_input_remote_ptr_buffers[sequence_i];

        init_params.cb_mode = input_packetize[sequence_i];
...
inline void initialize_output_queues() {
    ...
    process_queues<output_queue_network_sequence, output_queue_cb_mode_sequence>([&]<auto network_type, auto cbmode, auto sequence_i>(auto) -> bool {
        ...
        init_params.ptrs_addr = vc_packet_router_output_ptr_buffers[sequence_i],
        init_params.remote_ptrs_addr = vc_packet_router_output_remote_ptr_buffers[sequence_i],

        init_params.cb_mode = output_depacketize[sequence_i];
