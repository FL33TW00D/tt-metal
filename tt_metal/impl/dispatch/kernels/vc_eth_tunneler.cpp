...
PacketInputQueueVariant raw_input_queues[MAX_TUNNEL_LANES];
...
PacketOutputQueueVariant raw_output_queues[MAX_TUNNEL_LANES];
...
void initialize_input_queues() {
    ...
    process_queues<input_queue_network_sequence, input_queue_cb_mode_sequence>([&]<auto network_type, auto cbmode, auto sequence_i>(auto) -> bool {
        ...
        init_params.ptrs_addr = vc_eth_tunneler_input_ptr_buffers[sequence_i];
        init_params.remote_ptrs_addr = vc_eth_tunneler_input_remote_ptr_buffers[sequence_i];
...
void initialize_output_queue() {
    ...
    process_queues<output_queue_network_sequence, output_queue_cb_mode_sequence>([&]<auto network_type, auto cbmode, auto sequence_i>(auto) -> bool {
        ...
        init_params.ptrs_addr = vc_eth_tunneler_output_ptr_buffers[sequence_i],
        init_params.remote_ptrs_addr = vc_eth_tunneler_output_remote_ptr_buffers[sequence_i],
