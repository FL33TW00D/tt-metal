...
void LightMetalBeginCapture(Device* device) { device->light_metal_begin_capture(); }

std::vector<uint8_t> LightMetalEndCapture(Device* device) { return device->light_metal_end_capture(); }
