    ...
    def __call__(self, ttnn_Attention, hidden_states_i, encoder_hidden_states_i, attention_mask, device=None):
        ...
        if encoder_hidden_states_exist:
            ...
            encoder_hidden_states_query_proj = ttnn.experimental.nlp_create_qkv_heads_sd35(
                encoder_hidden_states_query_proj, memory_config=ttnn.DRAM_MEMORY_CONFIG
            )[0]
            #
        ...
        key = ttnn.experimental.nlp_create_qkv_heads_sd35(key, memory_config=ttnn.DRAM_MEMORY_CONFIG)[0]
        ...
        value = ttnn.experimental.nlp_create_qkv_heads_sd35(value, memory_config=ttnn.DRAM_MEMORY_CONFIG)[0]
